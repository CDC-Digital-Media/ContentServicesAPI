...
{
    public class OrganizationSearchDataMgr : RegistrationBaseSearchMgr<OrganizationObject>
    {
        public override DataSetResult GetData(SearchPlan searchPlan, ResultSetParms resultSetParms)
        {
            ...
            {
                IQueryable<OrganizationObject> orgItems = OrganizationCtl.Get(registrationDb);
