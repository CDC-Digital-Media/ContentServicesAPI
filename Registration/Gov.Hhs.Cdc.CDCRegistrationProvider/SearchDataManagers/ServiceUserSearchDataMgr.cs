...
{
    public class ServiceUserSearchDataMgr : RegistrationBaseSearchMgr<ServiceUserObject>
    {
        public override DataSetResult GetData(SearchPlan searchPlan, ResultSetParms resultSetParms)
        {
            ...
            {
                IQueryable<ServiceUserObject> orgItems = ServiceUserCtl.Get(registrationDb);
