...
{
    public class UserOrganizationSearchDataMgr : RegistrationBaseSearchMgr<UserOrganizationObject>
    {
        public override DataSetResult GetData(SearchPlan searchPlan, ResultSetParms resultSetParms)
        {
            ...
            {
                IQueryable<UserOrganizationObject> orgItems = UserOrganizationCtl.Get(registrationDb);
