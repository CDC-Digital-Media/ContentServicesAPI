...
{
    public class OrganizationTypeSearchDataMgr : RegistrationBaseSearchMgr<OrgTypeObject>
    {
        public override DataSetResult GetData(SearchPlan searchPlan, ResultSetParms resultSetParms)
        {
            ...
            {
                IQueryable<OrgTypeObject> orgItems = (IQueryable<OrgTypeObject>)new OrgTypeCtl().Get(registrationDb);
