...
{
    public class ApiClientSearchDataMgr : RegistrationBaseSearchMgr<ApiClientObject>
    {
        public override DataSetResult GetData(SearchPlan plan, ResultSetParms resultSetParms)
        {
            ...
            {
                IQueryable<ApiClientObject> items = ApiClientCtl.Get(registrationDb);
                return CreateDataSetResults(items, plan, resultSetParms.ResultSetId);
            }
        }
    }
}
