...
namespace Gov.Hhs.Cdc.CdcEmailProvider
{
    ...
    public class EmailObjectContextFactory : IObjectContextFactory
    {
        private const string ApplicationCode = "MediaValidation";

        public IDataServicesObjectContext Create()
        {
            return new EmailObjectContext(ObjectContextFactoryUtility.GetConnectionStringFromName(this.ConnectionStringName));
        }
