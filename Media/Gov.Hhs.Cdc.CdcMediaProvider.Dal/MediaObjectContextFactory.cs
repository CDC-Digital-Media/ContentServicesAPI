...
{
    public class MediaObjectContextFactory : IObjectContextFactory
    {
        public IDataServicesObjectContext Create()
        {
            return new MediaObjectContext(ObjectContextFactoryUtility.GetConnectionStringFromName(this.ConnectionStringName));
        }
