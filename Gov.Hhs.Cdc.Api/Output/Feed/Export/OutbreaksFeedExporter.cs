...
{
    public class OutbreaksFeedExporter : FeedExportBase
    {
        public OutbreaksFeedExporter(List<MediaObject> medias, FeedExportObject feedExport)
            ...
            try
            {
                if (this.FeedFormat != null && !string.IsNullOrEmpty(this.FeedFormat.FeedTemplate) && !string.IsNullOrEmpty(this.FeedFormat.FeedItemTemplate))
                {
                    ...
                    if (this.MediaItems != null)
                    {
                        ...
                        {
                            sbFeedItem.AppendFormat(this.FeedFormat.FeedItemTemplate, item.Title, item.TargetUrl);
                        }
                    }
                    ...
                    sbFeed.AppendFormat(this.FeedFormat.FeedTemplate, this.Media.TargetUrl, sbFeedItem.ToString());
