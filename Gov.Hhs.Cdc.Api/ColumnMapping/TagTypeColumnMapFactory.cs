...
{
    public class TagTypeColumnMapFactory : ColumnMapFactory<SerialTagType>
    {
        /// <summary>
        ...
        protected override Dictionary<string, string> CreateMapping(int version, bool isPublicFacing)
        {
            ...
            mapping.Add("id", "TagTypeId");
            mapping.Add("name", "TagTypeName");
            mapping.Add("decription", "Description");
            return mapping;
        }
