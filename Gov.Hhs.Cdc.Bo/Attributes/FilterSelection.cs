...
{
    public enum FilterTextType { Equals, Contains, StartsWith, EndsWith }
    public enum FilterCriterionType { Text, Boolean, DateRange, DropDownList, SingleSelect, MultiSelect, HierMultiSelect }

    [AttributeUsage(AttributeTargets.All, AllowMultiple = true)]
    public class FilterSelection : Attribute
    {
